...
//        }
        ...
        habitaciones habitacionDoble1 = new habitaciones(421, true);
        habitaciones habitacionDoble2 = new habitaciones(422, true);
        habitaciones habitacionDoble3 = new habitaciones(441, true);
        for (i = 101; i <= 120; i++) {
       ...
       habitaciones habitacionTriple1 = new habitaciones(631, true);
        habitaciones habitacionTriple2 = new habitaciones(632, true);
        habitaciones habitacionTriple3 = new habitaciones(661, true);
        for (i = 151; i <= 165; i++) {
        ...
        for (i = 181; i <= 190; i++) {
         ...
         habitaciones habitacionSuite = new habitaciones(213, true);
        habitaciones habitacionSuite2 = new habitaciones(223, true);
